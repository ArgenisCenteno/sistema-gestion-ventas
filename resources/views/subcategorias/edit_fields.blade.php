<div class="modal fade" id="modalEditarSubcategoria" tabindex="-1" aria-labelledby="modalEditarSubcategoriaLabel"
    aria-hidden="true">
        ...
        @method('PATCH')
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control round" id="edit_nombre" name="nombre" required>
                    </div>

                    <div class="mb-3">
                        <label for="edit_status" class="form-label fw-bold">Estado</label>
                        <select class="form-control round" id="edit_status" name="status" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control round" id="edit_categoria" name="categoria_id" required>
