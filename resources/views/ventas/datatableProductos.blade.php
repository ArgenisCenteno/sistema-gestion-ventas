...
<h4 class="mt-4 mb-4 p-3">CARRITO DE COMPRAS</h4>
<div class="table-responsive">
                ...
                columns: [
                    ...
                    { data: 'subCategoria', name: 'subCategoria' },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            return `<button type="button" class="btn btn-success" onClick="modificarTabla('${data}')"><span class="material-icons">add</span></button>`;
                        }
                    }
                ],
                order: [[0, 'desc']],
        ...
        function modificarTabla(id) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    if (data) {
                        console.log(data.subcategoria.nombre)
                        agregarProducto(
                            data.nombre,
                            data.precio_venta,
                            data.cantidad,
